...
//Insert Query of SQL
$query = mysql_query("insert into scclub_data(category, agent, date_now, surelastname, bank, banknumber, user, withdraw, deposit, bonus, tperson, avatar, note, qrcodepay) values ('$category', '$agent', '$date_now', '$surelastname', '$bank', '$banknumber', '$user', '$withdraw', '$deposit', '$bonus', '$tperson', '$avatar', '$note', '$qrcodepay')");
...
<div id="outerufa-cradit">
    ...
    <iframe name="checkcradit" id="innerufa-cradit" width="100%" height="" src="http://ag.ufabet.com/_Age/AccBal.aspx?role=ag&userName=uffq01&searchKey=<?php echo $objResult["user"];?>" scrolling="no" frameborder="0"></iframe>
...
<h2>
    ...
    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">ตรวจสอบเครดิต</button>
                        ...
                        <!-- /.panel-heading -->
                        <div class="panel-body">
<iframe width="100%" height="600" src="http://ag.ufabet.com/_Age/SubAccsWinLose2.aspx?role=ag&userName=uffq01&catId=&gId=-1" scrolling="yes" frameborder="0"></iframe>
                            <!-- /.table-responsive -->
