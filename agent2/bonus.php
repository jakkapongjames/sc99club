    ...
    <div id="wrapper">
       ...
       <?php include'nav.php'?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="page-header">รายการแจกโบนัส</h1>
                </div>
...
<?php
        ...
        $sql = "SELECT category,transactionid,user,agent,date_now,surelastname,banknumber,bank,tel,idline,deposit,bonus,withdraw,tperson,aperson,note,liststatus,ip
                FROM scclub_data2 WHERE (liststatus = 'confirm' AND bonus !='')
        ...
        if(!empty($_POST['date_from']) && !empty($_POST['date_to'])){
            ...
            $sql = "SELECT category,transactionid,user,agent,date_now,surelastname,banknumber,bank,tel,idline,deposit,bonus,withdraw,tperson,aperson,note,liststatus,ip
                    FROM scclub_data2 WHERE (liststatus = 'confirm' AND date_now BETWEEN '$date_from' AND '$date_to' AND bonus !='')
...
<div class="fixmargin"> </div>
                        ...
                        <div class="panel panel-primary fixbt">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-3">
