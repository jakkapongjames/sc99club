...
<?php include"head.php" ?>
    ...
    <title>แผงควบคุมการเงิน SCCLUB99 Agent2</title>
...
<?php include'nav.php'?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">แผงควบคุม Agent2 (<?php echo date("d-m-Y");  ?>)</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<iframe src="http://ag.ufabet.com/_Age/MemberOuts.aspx?role=ag&userName=uffqa
