...
<?php include"head.php" ?>
    ...
    <title>!!! กำลังทำรายการอัตโนมัติ  !!!</title>
       ...
       <?php include'nav.php'?>
        ...
        <div id="page-wrapper">
            ...
            <form action="save-cfd.php?transactionid=<?php echo $_GET["transactionid"];?>" name="frmEdit" method="post">
                ...
                <h1 class="text-center" style="color: #361754;">กำลังทำรายการกรุณารอสักครู่</h1>
                <div class="bar"></div>
...
<form>
                    ...
                    <div class="col-md-6" style="margin-bottom: 50px;">
                           ...
                           <iframe src="http://ag.ufabet.com/_Age/AccPay.aspx?userName=<?php echo $objResult["user"];?>&role=ag&amt=-<?php echo $objResult["withdraw"];?>" height="1" width="1" scrolling="no" frameBorder="0";></iframe>
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="margin-top: 50%;">
      ...
      <div class="modal-header">
        <h4 class="modal-title">สถานะการเติมเงิน</h4>
...
<h1 class="text-center">ทำรายการเรียบร้อยแล้ว</h1><br>
<a href="http://ag.ufabet.com/_Age/AccBal.aspx?role=ag&userName=uffqa&searchKey=<?php echo $objResult["user"];?>" target="_blank"><h3 class="text-center">เช็คเครดิต</h3></a>
...
<button class="btn btn-success btn-block btn-lg" id="checkcradit" onclick="refreshIframe();">ตกลง</button>
      </div>
