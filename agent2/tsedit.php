...
<?php include"head.php" ?>
    ...
    <title>แก้ไขรายการธุรกรรม</title>
    ...
    <div id="wrapper">
       ...
       <?php include'nav.php'?>
        ...
        <div id="page-wrapper">
            ...
            <form action="savetsedit.php?transactionid=<?php echo $_GET["transactionid"];?>" name="frmEdit" method="post">
...
{
?>
                <h2 style="text-align: center;">แก้ไขข้อมูลธุรกรรมของ : (<?php echo $objResult["user"];?>)</h2>
                <hr>
               <div class="row">
                    <div class="col-md-6">
                    <input type="hidden" name="transactionid" class="form-control" value="<?php echo $objResult["transactionid"];?>"/>
                        ...
                        <div class="form-group col-md-6"> ฝาก
                            <input type="text" name="txtdeposit" class="form-control" value="<?php echo $objResult["deposit"];?>" />
                        </div>

                        <div class="form-group col-md-6"> ถอน
                            <input type="text" name="txtwithdraw" class="form-control" value="<?php echo $objResult["withdraw"];?>" />
                        </div>

                        <div class="form-group col-md-6"> โบนัส
                            <input type="text" name="txtbonus" class="form-control" value="<?php echo $objResult["bonus"];?>" />
                        </div>
                        <div class="form-group col-md-6"> ผู้ทำรายการ
                          <input type="text" name="txttperson" class="form-control" value="<?php echo $objResult["tperson"];?>" />
                        </div>

                        <div class="form-group col-md-12"> เวลาทำรายการ
                          <input type="text" name="txtdate_now" class="form-control" value="<?php echo $objResult["date_now"];?>" />
                        </div>

                        <div class="form-group col-md-12">
                        <h4>สถานะการตรวจสอบธุรกรรม</h4>
                      <select class="form-control" name="txtliststatus">
                    <option name="txtliststatus" value="confirm">อนุมัติ</option>
                    <option name="txtliststatus" value="unconfirm">ยกเลิกรายการ</option>
                </select>
              </div>
