<button type="button" class="btn btn-success" onclick="window.location.href='formregister1.php'">ฝากเงิน</button>
<button type="button" class="btn btn-primary"onclick="window.location.href='formregister2.php'">สมัครสมาชิก</button>
<button type="button" class="btn btn-secondary" onclick="window.location.href='formregister3.php'">เติมโบนัส</button>
...
if($name !=''||$deposit !=''){
//Insert Query of SQL
$query = mysql_query("insert into scclub_data2(category, user,agent, date_now, surelastname, bank, banknumber, tel, idline, deposit, bonus, tperson, clubpoint) values ('$category', '$user', '$agent', '$date_now', '$surelastname', '$bank', '$banknumber', '$tel', '$idline', '$deposit', '$bonus', '$tperson' ,'$clubpoint')");
