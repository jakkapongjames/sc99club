...
<a href="http://ag.ufabet.com/_Age/AccBal.aspx?role=ag&userName=uffq01&searchKey=<?php echo $objResult["user"];?>" target="_blank"><h3 class="text-center">เช็คเครดิต</h3></a>
