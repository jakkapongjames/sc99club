...
<form>
                    ...
                    <div class="col-md-6" style="margin-bottom: 50px;">
                           ...
                           <iframe src="http://ag.ufabet.com/_Age/AccPay.aspx?userName=<?php echo $objResult["user"];?>&role=ag&amt=<?php echo $topup?>" height="1" width="1" scrolling="no" frameBorder="0";></iframe>
...
<h1 class="text-center">User : <?php echo $objResult["user"]; ?></h1>
<h1 class="text-center">ทำรายการเรียบร้อยแล้ว</h1>
